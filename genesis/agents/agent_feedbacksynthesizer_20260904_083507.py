"""
genesis/agents/agent_feedbacksynthesizer_20260904_083507.py
Specialist Agent: FeedbackSynthesizer
...
log = logging.getLogger("feedbacksynthesizer")

class SpecialistAgent:
    """Isolated specialist agent."""
    def __init__(self) -> None:
        self.role = "FeedbackSynthesizer"
        self.purpose = "Reviews execution failures and proposal rejections to update swarm guidelines dynamically"
