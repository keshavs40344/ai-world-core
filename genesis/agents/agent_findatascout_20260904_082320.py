"""
genesis/agents/agent_findatascout_20260904_082320.py
Specialist Agent: FinDataScout
...
log = logging.getLogger("findatascout")

class SpecialistAgent:
    """Isolated specialist agent."""
    def __init__(self) -> None:
        self.role = "FinDataScout"
        self.purpose = "Harvests unauthenticated public financial/crypto metrics, volume anomalies, and macro indicators"
