"""
genesis/agents/agent_adamscanner_20260904_083001.py
Specialist Agent: AdamScanner
...
log = logging.getLogger("adamscanner")

class SpecialistAgent:
    """Isolated specialist agent."""
    def __init__(self) -> None:
        self.role = "AdamScanner"
        self.purpose = "Continuous listener across HackerNews, GitHub, and RSS stream feeds"
