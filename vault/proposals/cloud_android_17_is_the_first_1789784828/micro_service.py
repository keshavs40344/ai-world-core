...
# Target Objective: Android 17 is the first since 3.x to add new APIs without releasing to the AOSP
...
class DataStreamNormalizer:
    ...
    def __init__(self, service_name: str = "android_17_is_the_first"):
