...
# Target Objective: Mistral raises €3B to make sovereign, open-weight AI the technology frontier
...
class DataStreamNormalizer:
    ...
    def __init__(self, service_name: str = "mistral_raises__3b_to_ma"):
