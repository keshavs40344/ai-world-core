...
# Target Objective: Show HN: An e-ink frame that hears birds and draws them as 1800s illustrations
...
class DataStreamNormalizer:
    ...
    def __init__(self, service_name: str = "show_hn__an_e_ink_frame"):
