...
# Target Objective: Google AI Mode shows same products 21.6% more expensive than traditional search
...
class DataStreamNormalizer:
    ...
    def __init__(self, service_name: str = "google_ai_mode_shows_sam"):
