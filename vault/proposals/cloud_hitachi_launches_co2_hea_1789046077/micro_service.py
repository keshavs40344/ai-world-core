...
# Target Objective: Hitachi launches CO2 heat pump water heaters with solar-friendly tariff controls
...
class DataStreamNormalizer:
    ...
    def __init__(self, service_name: str = "hitachi_launches_co2_hea"):
