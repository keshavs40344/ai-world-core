...
# Target Objective: Astra and Fable still hack on simple variants of alignment evals from 2025
...
class DataStreamNormalizer:
    ...
    def __init__(self, service_name: str = "astra_and_fable_still_ha"):
