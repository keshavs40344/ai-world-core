        ...
        _injectAuthModal: function() {
            ...
            div.innerHTML = `
                <div class="bg-slate-900 border border-slate-800 max-w-md w-full rounded-3xl p-6 sm:p-7 shadow-2xl relative text-slate-100">
                    ...
                    <button type="button" onclick="window.handleFirebaseGoogleSignIn()" class="w-full py-3 px-4 rounded-xl bg-slate-950 hover:bg-slate-800 border border-slate-700 hover:border-slate-500 text-white text-xs font-mono font-bold flex items-center justify-center gap-2.5 transition shadow-sm mb-4">
